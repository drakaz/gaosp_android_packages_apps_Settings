...
/**
 * Confirm and execute a format of the external sdcard.
 ...
 */
public class MediaFormat_ext extends Activity {
            ...
            public void onClick(View v) {
                ...
                if (service != null) {
                    new Thread() {
                        public void run() {
                            try {
                                service.formatVolume(Environment.getExternalSdDirectory().toString());
                            } catch (Exception e) {
